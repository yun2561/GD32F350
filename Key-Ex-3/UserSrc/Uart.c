...
void UART_Init(void)
{   
    uart_dma_hw_config_t uart0_port_config ={
        .uart_config ={
            .uart_periph = uart_0_periph,
            .baudrate = uart_0_baudrate,
...
uart_dma_error_t uart_dma_init(uart_dma_hw_config_t* config)
{
    if (config == NULL){
